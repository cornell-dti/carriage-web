...
const Table = () => {
  const [drivers, setDrivers] = useState([
    ...
    },
    {
      name: 'Driver2',
      netid: 'asd23',
      email: 'asd23@cornell.edu',
      phone: '222-222-2222',
    },
    {
      name: 'Driver3',
      netid: 'advs12',
      email: 'advs12@cornell.edu',
      phone: '333-333-3333',
    },
    {
      name: 'Driver4',
      netid: 'bfd2',
      email: 'bfd2@cornell.edu',
      phone: '444-444-4444',
    },
  ]);
    ...
    return allDrivers.map((driver) => {
      ...
      return (
        <tr key={netid}>
          ...
          <td>{phone}</td>
          <td>
            <button onClick={() => setDrivers(deleteEntry(netid, allDrivers))}>
              Delete
            </button>
          </td>
        </tr>
  ...
  return (
    <>
      ...
      <div>
        <Form
          onClick={(newDriver) => setDrivers(addDriver(newDriver, drivers))}
        />
      </div>
    </>
  );
