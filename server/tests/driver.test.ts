...
describe('Testing Functionality of Drivers Endpoints', () => {
  ...
  // testing retrieval of all drivers without admin privileges
  const generateErrorAllDriversTest = async (authToken: string) => {
    const res = await request(app)
      .get('/api/drivers/')
      .auth(authToken, { type: 'bearer' })
      .expect(400)
  ...
  describe('GET all drivers', () => {
    ...
    it('should fail with 400 given Driver account', async () =>
      await generateErrorAllDriversTest(driverToken));
    it('should fail with 400 given Rider account', async () =>
      await generateErrorAllDriversTest(riderToken));
    it('should fail with 400 given no authorization header', async () => {
  ...
  const generateCreateDriverErrorTest = async (authToken: string) => {
    const res = await request(app)
      .post('/api/drivers/')
      .send(newDriverData)
      .auth(authToken, { type: 'bearer' })
  ...
  describe('Create a new driver', () => {
    ...
    it('should fail with 400 given Driver account', async () =>
      await generateCreateDriverErrorTest(driverToken));
    it('should fail with 400 given Rider account', async () =>
      await generateCreateDriverErrorTest(riderToken));
    it('should fail with 400 given no authorization header', async () => {
  ...
  const generateUpdateDriverErrorTest = async (authToken: string) => {
    const res = await request(app)
      .put('/api/drivers/driver0')
      .send({ firstName: 'NewName' })
      .auth(authToken, { type: 'bearer' })
  ...
  describe('PUT new information for a driver by id driver0', () => {
    ...
    it('should fail with 400 given Rider account', async () =>
      await generateUpdateDriverErrorTest(riderToken));
    it('should fail with 400 given no authorization header', async () => {
  ...
  const generateDeleteDriverErrorTest = async (authToken: string) => {
    const res = await request(app)
      .delete('/api/drivers/driver0')
      .auth(authToken, { type: 'bearer' })
      .expect(400)
  ...
  describe('DELETE a driver by id driver0', () => {
    ...
    it('should fail with 400 given Driver account', async () =>
      await generateDeleteDriverErrorTest(driverToken));
    it('should fail with 400 given Rider account', async () =>
      await generateDeleteDriverErrorTest(riderToken));
    it('should fail with 400 given no authorization header', async () => {
